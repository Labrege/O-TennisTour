<head>
    <!-- SEO -->
    <title> O'TENNIS TOUR | Information Covid </title>
    <meta name="description" content="Information Covid-19">
...
<div class="rest">
    <div id='espace_membre_stages' class="espace_membre_stages">
        ...
        <div class="intro-stage-container">
            <img class='intro-background-image' src="Images/filet.jpg" alt="">
            <div class="intro-stage-screen"></div>
            <div class="intro-text-background">
                <h1> INFORMATION COVID-19 </h1>
                <div class="intro-text-container">
                    <div class="intro-text">
                        <img class='intro-text-image' src="Images/covid.jpg" alt="">
                    </div>
                    <div class="intro-text">
                        ...
                        Afin de pouvoir profiter de l'expérience O'Tennis Tour sans crainte, merci de respecter les règles suivantes :
                ...
                <br>
                <a href="https://www.gouvernement.fr/info-coronavirus" target='_blank' class="btn-link">
                <div class="button-container">
                    <h2> Plus sur la COVID-19</h2>
                </div>
                </a>
            </div>
        </div>
