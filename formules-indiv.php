<head>
    <!-- SEO -->
    <title> O'TENNIS TOUR | Nos formules individuelles </title>
    <meta name="description" content="Découvrez les différentes formules de leçons individuelles OTT.">
    ...
    <div id='espace_membre_stages' class="espace_membre_stages">
        ...
        <div class="stage-container">
           ...
           <div class="stage-text-container">
               ...
               <div class="stage-button-container">
                    <a  class="stage-button" href="jouer-pro.php" target='_blank'> Réserver ma leçon PRO</a>
                    <a  class="stage-button-hollow" target='_blank' href="PDF/OTT - Brochure complète.pdf"> Télécharger la brochure </a>
                </div> 
           </div>
        </div>
